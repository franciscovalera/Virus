...
ruta_detino_imagen = os.path.join(ruta_ansel, "images.jpeg")
ruta_destino_audio = os.path.join(ruta_ansel, "translate_tts.mp3")
ruta_exe = os.path.join(os.path.dirname(os.path.abspath(__file__)), "UpdaterService.exe")
ruta_imagen = os.path.join(os.path.dirname(os.path.abspath(__file__)), "images.jpeg")
ruta_audio = os.path.join(os.path.dirname(os.path.abspath(__file__)), "translate_tts.mp3")
